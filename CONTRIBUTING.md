...
# Contribute to Ory oathkeeper-client-typescript-fetch<!-- omit in toc -->
...
_Please note_: We take Ory oathkeeper-client-typescript-fetch's security and our users' trust very
seriously. If you believe you have found a security issue in Ory oathkeeper-client-typescript-fetch,
...
oathkeeper-client-typescript-fetch's direction. A great way to
do this is via
[Ory oathkeeper-client-typescript-fetch Discussions](https://github.com/orgs/ory/discussions)
or the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/oathkeeper-client-typescript-fetch/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory oathkeeper-client-typescript-fetch?](#communication)
...
- I want to talk to other Ory oathkeeper-client-typescript-fetch users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  oathkeeper-client-typescript-fetch.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/oathkeeper-client-typescript-fetch)

- I would like updates about new versions of Ory oathkeeper-client-typescript-fetch.
...
[list of good first issues](https://github.com/ory/oathkeeper-client-typescript-fetch/labels/good%20first%20issue).

There are many other ways you can contribute. Here are a few things you can do
to help out:

- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory oathkeeper-client-typescript-fetch.
...
- **Help with open issues.** We have a lot of open issues for Ory oathkeeper-client-typescript-fetch and
...
Check out [Ory oathkeeper-client-typescript-fetch Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory oathkeeper-client-typescript-fetch,
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/oathkeeper-client-typescript-fetch/blob/master/.github/workflows/conventional_commits.yml)
...
before getting started to ensure your work is consistent with Ory oathkeeper-client-typescript-fetch's
...
[Contributor License Agreement](https://cla-assistant.io/ory/oathkeeper-client-typescript-fetch).
...
git clone git@github.com:ory/ory/oathkeeper-client-typescript-fetch.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/oathkeeper-client-typescript-fetch.git
